...
: hashTableSize_(hashTableSize), joinTableSize_(hashTableSize),
  hash_prefix_sum_temp_buffer_(nullptr), hash_prefix_sum_temp_buffer_size_(0),
  join_prefix_sum_temp_buffer_(nullptr), join_prefix_sum_temp_buffer_size_(0)
{
    ...
    GPUMemory::alloc<int8_t>(reinterpret_cast<int8_t**>(&hash_prefix_sum_temp_buffer_),
                             hash_prefix_sum_temp_buffer_size_);
    ...
    GPUMemory::alloc<int8_t>(reinterpret_cast<int8_t**>(&join_prefix_sum_temp_buffer_),
                             join_prefix_sum_temp_buffer_size_);
}
