...
public:
    ...
    template <class T>
    static void Compress(DataType columnType,
                         ...
                         bool& compressedSuccessfully)
    {
        ...
        if (columnType == COLUMN_INT || columnType == COLUMN_LONG || columnType == COLUMN_INT8_T)
        {
            compressedSuccessfully =
                CompressionGPU::compressDataAAFL(hostUncompressed, uncompressedElementsCount, hostCompressed,
    ...
    /// <param name="compressedSuccessfully">Output parameter representing result of compression</param>
    template <class T>
    static void Decompress(DataType columnType,
                           ...
                           bool& decompressedSuccessfully)
    {
        if (columnType == COLUMN_INT || columnType == COLUMN_LONG || columnType == COLUMN_INT8_T)
        {
            decompressedSuccessfully =
                CompressionGPU::decompressDataAAFL(hostCompressed, compressedElementsCount, hostUncompressed,
                           ...
                           bool onDevice = true)
    {
        ...
        {
            decompressedSuccessfully =
                CompressionGPU::decompressDataAAFLOnDevice(deviceCompressed, uncompressedElementsCount,
                                                           compressedElementsCount, compressionBlocksCount,
                                                           deviceUncompressed, minValue, maxValue);
        }
        else if (columnType == COLUMN_FLOAT)
        {
            decompressedSuccessfully =
