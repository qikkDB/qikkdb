...
#ifdef MERGED
#define DISPATCHER_UNARY_FUNCTION_MERGED(DOP, OP, TYPEL) \
    DISPATCHER_FUN(DOP, OP, TYPEL), DISPATCHER_FUN(DOP, OP, TYPEL*),
#else
#define DISPATCHER_UNARY_FUNCTION_MERGED(DOP, OP, TYPEL) \
    DISPATCHER_FUN(DOP##Const, OP, TYPEL), DISPATCHER_FUN(DOP##Col, OP, TYPEL),
#endif
...
#define DISPATCHER_INVALID_TYPE(OP, TYPE)                        \
    ...
    DISPATCHER_ERROR(OP, TYPE, QikkDB::Types::Point)          \
    DISPATCHER_ERROR(OP, TYPE, QikkDB::Types::ComplexPolygon) \
...
#define DISPATCHER_INVALID_TYPE_NOOP(TYPE)                   \
    ...
    DISPATCHER_ERROR(TYPE, QikkDB::Types::Point)          \
    DISPATCHER_ERROR(TYPE, QikkDB::Types::ComplexPolygon) \
...
#define DISPATCHER_POINT_ENABLE_0(DOP, OP, TYPE) DISPATCHER_ERROR(OP, TYPE, QikkDB::Types::Point)
#define DISPATCHER_POINT_ENABLE_1(DOP, OP, TYPE) \
    DISPATCHER_FUNCTION_MERGED(DOP, OP, TYPE, QikkDB::Types::Point)

#define DISPATCHER_POLYGON_ENABLE_0(DOP, OP, TYPE) \
    DISPATCHER_ERROR(OP, TYPE, QikkDB::Types::ComplexPolygon)
#define DISPATCHER_POLYGON_ENABLE_1(DOP, OP, TYPE) \
    DISPATCHER_FUNCTION_MERGED(DOP, OP, TYPE, QikkDB::Types::ComplexPolygon)
...
#define DISPATCHER_POINT_NOLEFT_ENABLE_0(DOP, OP) DISPATCHER_ERROR(OP, QikkDB::Types::Point)
#define DISPATCHER_POINT_NOLEFT_ENABLE_1(DOP, OP) \
    DISPATCHER_FUNCTION(DOP, OP, QikkDB::Types::Point)

#define DISPATCHER_POLYGON_NOLEFT_ENABLE_0(DOP, OP) \
    DISPATCHER_ERROR(OP, QikkDB::Types::ComplexPolygon)
#define DISPATCHER_POLYGON_NOLEFT_ENABLE_1(DOP, OP) \
    DISPATCHER_FUNCTION(DOP, OP, QikkDB::Types::ComplexPolygon)
...
#define DISPATCHER_POINT_NOOP_ENABLE_0(DOP, TYPE) DISPATCHER_ERROR(TYPE, QikkDB::Types::Point)
#define DISPATCHER_POINT_NOOP_ENABLE_1(DOP, TYPE) \
    DISPATCHER_FUNCTION(DOP, TYPE, QikkDB::Types::Point)

#define DISPATCHER_POLYGON_NOOP_ENABLE_0(DOP, TYPE) \
    DISPATCHER_ERROR(TYPE, QikkDB::Types::ComplexPolygon)
#define DISPATCHER_POLYGON_NOOP_ENABLE_1(DOP, TYPE) \
    DISPATCHER_FUNCTION(DOP, TYPE, QikkDB::Types::ComplexPolygon)
...
#define DISPATCHER_POINT_NOCONST_NOOP_ENABLE_1(DOP, TYPE) \
    DISPATCHER_FUNCTION_NOCONST(DOP, TYPE, QikkDB::Types::Point)

#define DISPATCHER_POLYGON_NOCONST_NOOP_ENABLE_0(DOP, TYPE) \
    DISPATCHER_ERROR(TYPE, QikkDB::Types::ComplexPolygon)
#define DISPATCHER_POLYGON_NOCONST_NOOP_ENABLE_1(DOP, TYPE) \
    DISPATCHER_FUNCTION_NOCONST(DOP, TYPE, QikkDB::Types::ComplexPolygon)
...
#define DISPATCHER_POINT_GROUPBY_ENABLE_1(DOP, OP, TYPE) \
    DISPATCHER_GROUPBY_FUNCTION(DOP, OP, QikkDB::Types::Point, TYPE, QikkDB::Types::Point)

#define DISPATCHER_POLYGON_GROUPBY_ENABLE_0(DOP, OP, TYPE) \
    DISPATCHER_ERROR(OP, TYPE, QikkDB::Types::ComplexPolygon)
#define DISPATCHER_POLYGON_GROUPBY_ENABLE_1(DOP, OP, TYPE) \
    DISPATCHER_GROUPBY_FUNCTION(DOP, OP, QikkDB::Types::ComplexPolygon, TYPE, QikkDB::Types::ComplexPolygon)
...
#define DISPATCHER_POINT_GROUPBYRET_ENABLE_1(DOP, OP, RET, TYPE) \
    DISPATCHER_GROUPBY_FUNCTION(DOP, OP, RET, TYPE, QikkDB::Types::Point)
...
#define DISPATCHER_POLYGON_GROUPBYRET_ENABLE_1(DOP, OP, RET, TYPE) \
    DISPATCHER_GROUPBY_FUNCTION(DOP, OP, RET, TYPE, QikkDB::Types::ComplexPolygon)
