...
//DOUBLE "!="
TEST(DispatcherTests, DoubleNotEqColumnConst) //FIXME this will never work because of kernel
{
	Context::getInstance();
...
TEST(DispatcherTests, DoubleNotEqConstColumn) //FIXME this will never work because of kernel
{
	Context::getInstance();
