...
std::vector<int32_t> polyApointsIdx = {7, 14, 21, 27, 37, 45, 52};
...
std::vector<int32_t> polyBpointsIdx = {6, 13, 20, 29, 38};
...
TEST(GPUPolygonClippingTests, IntersectTest)
{
	...
	polyTest<PolygonFunctions::polyIntersect>(
		polyApolyIdx,
		polyApointsIdx,
		polyApolyPoints,
		polyBpolyIdx,
...
TEST(GPUPolygonClippingTests, UnionTest)
{
	...
	// Run the union test
	polyTest<PolygonFunctions::polyUnion>(polyApolyIdx,
		polyApointsIdx,
		polyApolyPoints,
		polyBpolyIdx,
		polyBpointsIdx,
