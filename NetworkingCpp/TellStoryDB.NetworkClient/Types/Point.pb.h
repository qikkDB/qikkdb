...
PROTOBUF_NAMESPACE_OPEN
template <>
::ColmnarDB::Types::Point* Arena::CreateMaybeMessage<::ColmnarDB::Types::Point>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace ColmnarDB
{
namespace Types
...
class Point : public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:ColmnarDB.Types.Point) */
{
public:
    Point();
    virtual ~Point();
    ...
    Point(Point&& from) noexcept : Point()
    {
        *this = ::std::move(from);
    }
...
inline const ::ColmnarDB::Types::GeoPoint& Point::geopoint() const
{
    ...
    return p != nullptr ? *p :
                          *reinterpret_cast<const ::ColmnarDB::Types::GeoPoint*>(
...
inline void Point::set_allocated_geopoint(::ColmnarDB::Types::GeoPoint* geopoint)
{
    ...
    if (geopoint)
    {
        ...
        {
            geopoint = ::PROTOBUF_NAMESPACE_ID::internal::GetOwnedMessage(message_arena, geopoint, submessage_arena);
        }
    }
    else
    {
