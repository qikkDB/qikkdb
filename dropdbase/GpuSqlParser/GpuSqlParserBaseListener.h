...
public:
  ...
  virtual void enterNewTableIndex(GpuSqlParser::NewTableIndexContext * /*ctx*/) override { }
  virtual void exitNewTableIndex(GpuSqlParser::NewTableIndexContext * /*ctx*/) override { }
