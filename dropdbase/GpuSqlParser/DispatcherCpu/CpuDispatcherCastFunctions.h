...
int32_t CpuSqlDispatcher::castNumericCol()
{
	...
	std::cout << "Where evaluation castNumericCol_min: " << colName << ", " << reg + "_min" << ": " << resultMin[0] << std::endl;
	std::cout << "Where evaluation castNumericCol_max: " << colName << ", " << reg + "_max" << ": " << resultMax[0] << std::endl;
...
int32_t CpuSqlDispatcher::castNumericConst()
{
	...
	std::cout << "Where evaluation castNumericConst_min: " << reg + "_min" << ": " << resultMin[0] << std::endl;
	std::cout << "Where evaluation castNumericConst_max: " << reg + "_max" << ": " << resultMax[0] << std::endl;
