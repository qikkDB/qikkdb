...
int32_t CpuSqlDispatcher::stringUnaryCol()
{
	...
	char* resultMin = allocateRegister<char>(reg + "_min", resultStringMin.size() + 1, std::get<2>(colValMin) || !OP::isMonotonous);
	char* resultMax = allocateRegister<char>(reg + "_max", resultStringMax.size() + 1, std::get<2>(colValMax) || !OP::isMonotonous);
...
int32_t CpuSqlDispatcher::stringBinaryNumericColCol()
{
	...
	else
	{
		...
		std::string resultStringMin = OP{}(reinterpret_cast<char*>(std::get<0>(colValLeftMin)), std::get<1>(colValLeftMin), reinterpret_cast<T*>(std::get<0>(colValRightMin))[0]);
		std::string resultStringMax = OP{}(reinterpret_cast<char*>(std::get<0>(colValLeftMax)), std::get<1>(colValLeftMax), reinterpret_cast<T*>(std::get<0>(colValRightMax))[0]);

		resultMin = allocateRegister<char>(reg + "_min", resultStringMin.size() + 1, std::get<2>(colValLeftMin) || std::get<2>(colValRightMin) || !OP::isMonotonous);
		resultMax = allocateRegister<char>(reg + "_max", resultStringMax.size() + 1, std::get<2>(colValLeftMax) || std::get<2>(colValRightMax) || !OP::isMonotonous);
	...
	std::cout << "Where evaluation stringColCol_min: " << colNameLeft << ", " << colNameRight << ", " << reg + "_min" << ": " << resultMin[0] << std::endl;
	std::cout << "Where evaluation stringColCol_max: " << colNameLeft << ", " << colNameRight << ", " << reg + "_max" << ": " << resultMax[0] << std::endl;
...
int32_t CpuSqlDispatcher::stringBinaryNumericColConst()
{
	...
	std::string resultStringMin = OP{}(reinterpret_cast<char*>(std::get<0>(colValMin)), std::get<1>(colValMin), cnst);
	std::string resultStringMax = OP{}(reinterpret_cast<char*>(std::get<0>(colValMax)), std::get<1>(colValMax), cnst);
	...
	std::cout << "Where evaluation stringColConst_min: " << colName << ", " << reg + "_min" << ": " << resultMin[0] << std::endl;
	std::cout << "Where evaluation stringColConst_max: " << colName << ", " << reg + "_max" << ": " << resultMax[0] << std::endl;
...
int32_t CpuSqlDispatcher::stringBinaryNumericConstCol()
{
	...
	std::string resultStringMin = OP{}(cnst.c_str(), cnst.size(), reinterpret_cast<T*>(std::get<0>(colValMin))[0]);
	std::string resultStringMax = OP{}(cnst.c_str(), cnst.size(), reinterpret_cast<T*>(std::get<0>(colValMax))[0]);
	...
	std::cout << "Where evaluation stringConstCol_min: " << colName << ", "  << reg + "_min" << ": " << resultMin[0] << std::endl;
	std::cout << "Where evaluation stringConstCol_max: " << colName << ", "  << reg + "_max" << ": " << resultMax[0] << std::endl;
...
int32_t CpuSqlDispatcher::stringBinaryNumericConstConst()
{
	...
	std::cout << "Where evaluation stringConstConst_min: " << reg + "_min" << ": " << resultMin[0] << std::endl;
	std::cout << "Where evaluation stringConstConst_max: " << reg + "_max" << ": " << resultMax[0] << std::endl;
...
int32_t CpuSqlDispatcher::stringBinaryColCol()
{
	...
	else
	{
		...
		std::string resultStringMin = OP{}(reinterpret_cast<char*>(std::get<0>(colValLeftMin)), std::get<1>(colValLeftMin), reinterpret_cast<char*>(std::get<0>(colValRightMin)), std::get<1>(colValRightMin));
		std::string resultStringMax = OP{}(reinterpret_cast<char*>(std::get<0>(colValLeftMax)), std::get<1>(colValLeftMax), reinterpret_cast<char*>(std::get<0>(colValRightMax)), std::get<1>(colValRightMax));
...
int32_t CpuSqlDispatcher::stringBinaryColConst()
{
	...
	std::string resultStringMin = OP{}(reinterpret_cast<char*>(std::get<0>(colValMin)), std::get<1>(colValMin), cnst.c_str(), cnst.size());
	std::string resultStringMax = OP{}(reinterpret_cast<char*>(std::get<0>(colValMax)), std::get<1>(colValMax), cnst.c_str(), cnst.size());
...
int32_t CpuSqlDispatcher::stringBinaryConstConst()
{
	...
	std::string resultStringMin = OP{}(cnstLeft.c_str(), cnstLeft.size(), cnstRight.c_str(), cnstRight.size());
	std::string resultStringMax = OP{}(cnstLeft.c_str(), cnstLeft.size(), cnstRight.c_str(), cnstRight.size());
