...
public:
    ...
    enum
    {
        ...
        RuleSqlCreateDb = 7,
        RuleSqlDropDb = 8,
        RuleSqlCreateTable = 9,
        RuleSqlDropTable = 10,
        RuleSqlAlterTable = 11,
        RuleSqlCreateIndex = 12,
        RuleSqlInsertInto = 13,
        RuleNewTableEntries = 14,
        RuleNewTableEntry = 15,
        RuleAlterTableEntries = 16,
        RuleAlterTableEntry = 17,
        RuleAddColumn = 18,
        RuleDropColumn = 19,
        RuleAlterColumn = 20,
        RuleNewTableColumn = 21,
        RuleNewTableIndex = 22,
        RuleSelectColumns = 23,
        RuleSelectColumn = 24,
        RuleSelectAllColumns = 25,
        RuleWhereClause = 26,
        RuleOrderByColumns = 27,
        RuleOrderByColumn = 28,
        RuleInsertIntoValues = 29,
        RuleInsertIntoColumns = 30,
        RuleIndexColumns = 31,
        RuleGroupByColumns = 32,
        RuleGroupByColumn = 33,
        RuleFromTables = 34,
        RuleJoinClauses = 35,
        RuleJoinClause = 36,
        RuleJoinTable = 37,
        RuleJoinColumnLeft = 38,
        RuleJoinColumnRight = 39,
        RuleJoinOperator = 40,
        RuleJoinType = 41,
        RuleFromTable = 42,
        RuleColumnId = 43,
        ...
        RuleExpression = 53,
        RuleGeometry = 54,
        RulePointGeometry = 55,
        RuleLineStringGeometry = 56,
        RulePolygonGeometry = 57,
        RuleMultiPointGeometry = 58,
        RuleMultiLineStringGeometry = 59,
        RuleMultiPolygonGeometry = 60,
        RulePointOrClosedPoint = 61,
        RulePolygon = 62,
        RuleLineString = 63,
        RulePoint = 64
    };
