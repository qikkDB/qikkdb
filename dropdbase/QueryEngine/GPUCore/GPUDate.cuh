...
namespace DateOperations
{
	...
	__constant__ const int64_t START_DAYS_OF_LEAP_YEARS[] = { 0, 1461, 2922, 4383, 5844, 7305, 8766, 10227, 11688, 13149, 14610, 16071, 17532, 18993, 20454, 21915, 23376, 24837, 26298, 27759, 29220, 30681, 32142, 33603, 35064,
	...
	/// GPU constant buffer to accelerate date processing
	__constant__ const int64_t START_DAYS_OF_MONTHS[] = { 0, 31, 60, 91, 121, 152, 182, 213, 244, 274, 305, 335,
