...
public:
    ...
    HandleInfoMessage(ITCPWorker& worker, const ColmnarDB::NetworkClient::Message::InfoMessage& infoMessage) = 0;
    /// <summary>
    ...
    HandleCSVImport(ITCPWorker& worker,
                    const ColmnarDB::NetworkClient::Message::CSVImportMessage& csvImportMessage) = 0;
    /// <summary>
    /// Bulk import data
    /// </summary>
    /// <param name="worker">Worker that requested handling</param>
