    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 10)) {
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParserUTF8(_internal_mutable_databasename(), ptr, ctx, "ColmnarDB.NetworkClient.Message.SetDatabaseMessage.DatabaseName");
          CHK_(ptr);
