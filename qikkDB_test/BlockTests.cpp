...
TEST(BlockTests, BlockStatistics)
{
	...
	ASSERT_EQ(ComplexPolygonFactory::WktFromPolygon(blockPolygon.GetMin()),
              ColumnBase<QikkDB::Types::ComplexPolygon>::POLYGON_DEFAULT_VALUE);
    ASSERT_EQ(ComplexPolygonFactory::WktFromPolygon(blockPolygon.GetMax()),
              ColumnBase<QikkDB::Types::ComplexPolygon>::POLYGON_DEFAULT_VALUE);
    ASSERT_EQ(ComplexPolygonFactory::WktFromPolygon(blockPolygon.GetSum()),
              ColumnBase<QikkDB::Types::ComplexPolygon>::POLYGON_DEFAULT_VALUE);
